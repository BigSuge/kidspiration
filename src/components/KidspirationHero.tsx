  ...
  const slides = [
    {
      ...
      overlaySubtext: "Join the global movement of kids making a difference around the world",
    },
    {
      id: 2,
      type: 'image',
      ...
      overlaySubtext: "Enlist to join the ER100 CAMPAIGN, EVERYONE REACH 100 CHILDREN during the October Edition of the HEALING STREAMS LIVE HEALING SERVICES",
    },
    {
      id: 3,
      type: 'image',
      ...
      ctaAction: "httn",
      // NEW: Added Secondary CTA fields
      secondaryCtaText: "Order January Magazine",
      secondaryCtaAction: "portal",
      gradient: "from-teal-400 via-cyan-500 to-blue-500",
      overlayText: "HEALING TO THE NATIONS",
      overlaySubtext: "Experience our interactive digital magazine with inspiring stories and fun activities",
    },
    {
      id: 5,
      type: 'image',
      title: "Join the Translators Network ",
      subtitle: "Enlist as a Child Translator",
      description: "Trailblazers (Ages 9-12) - Translate God's Word to children worldwide.",
      image: image_bb07a1601daf44f77a41d1ac57e45dc5ac294a33,
      ctaText: "Enlist Now",
      ctaAction: "translators",
      gradient: "from-cyan-400 via-blue-500 to-indigo-500",
      overlayText: "KIDSPIRATION TRANSLATORS NETWORK",
      overlaySubtext: "Help reach children around the world by translating content into your local language",
    },
    {
      id: 6,
      type: 'image',
      ...
      overlaySubtext: "Discover amazing products while supporting children worldwide. Every purchase makes a difference!",
    },
    {
      id: 7,
      type: 'image',
      ...
      overlaySubtext: "Celebrating children who may have never had a birthday party before. Spreading love, joy, and the message of God's love to every child.",
    },
  ];
              ...
              >
                ...
                <div className="space-y-8">
                  ...
                  <div className="flex flex-wrap gap-4">
                    ...
                    {slides[currentSlide].secondaryCtaText && (
                      <button
                        ...
                        className="bg-transparent border-2 border-white/70 px-6 py-3 rounded-full text-base font-bold text-white hover:bg-white hover:text-cyan-700 transform hover:scale-105 transition-all"
                      >
                        {slides[currentSlide].secondaryCtaText}
                      </button>
                    )}
                  ...
                  <div className="flex gap-6">
                    <button onClick={prevSlide} className="w-15 h-15 bg-white/20 backdrop-blur-md rounded-full flex items-center justify-center hover:bg-white/30 hover:scale-110 transition-all border border-white/30 shadow-lg">
                      <ChevronLeft className="w-8 h-8 text-white" />
                    </button>
                    <button onClick={nextSlide} className="w-15 h-15 bg-white/20 backdrop-blur-md rounded-full flex items-center justify-center hover:bg-white/30 hover:scale-110 transition-all border border-white/30 shadow-lg">
            ...
            <div className={`bg-gradient-to-br ${slides[currentSlide].gradient} p-5 pb-16 flex flex-col justify-between flex-shrink-0 relative`}>
              ...
              >
                ...
                <div className="space-y-1">
                  <p className="text-white font-bold opacity-95 text-[16px]">
                    {slides[currentSlide].subtitle}
                  </p>
                ...
                <div className="pt-2 flex flex-wrap gap-3">
                  ...
                  {slides[currentSlide].secondaryCtaText && (
                    <button
                      onClick={() => handleCTA(slides[currentSlide].secondaryCtaAction!)}
                      className="bg-white/20 backdrop-blur-sm border-2 border-white/40 px-4 py-2 rounded-full font-bold text-white text-[14px]"
                    >
                      {slides[currentSlide].secondaryCtaText}
                    </button>
                  )}
              ...
              <div className="absolute bottom-5 right-5 flex gap-2 z-20">
                <button onClick={prevSlide} className="w-10 h-10 bg-white/20 backdrop-blur-md rounded-full flex items-center justify-center border border-white/30 shadow-lg">
                  <ChevronLeft className="w-5 h-5 text-white" />
                </button>
                <button onClick={nextSlide} className="w-10 h-10 bg-white/20 backdrop-blur-md rounded-full flex items-center justify-center border border-white/30 shadow-lg">
