...
export function KidspirationHero({
  ...
  const slides = [
    ...
    },
    {
      ...
      description:
        "Trailblazers (Ages 9-12) - Translate God's Word to children worldwide.",
      image:
        image_bb07a1601daf44f77a41d1ac57e45dc5ac294a33,
      ctaText: "Enlist Now",
      ctaAction: "translators",
      gradient: "from-cyan-400 via-blue-500 to-indigo-500",
      overlayText: "KIDSPIRATION TRANSLATORS NETWORK",
      overlaySubtext:
        "Help reach children around the world by translating content into your local language",
    },
    {
      id: 6,
      type: 'image',
