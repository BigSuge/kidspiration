...
export function GivePageOld({ onBack, onNavigate }: GivePageProps) {
  const { } = useAuth();
  ...
  const handleInputChange = (tierId: string, value: string) => {
                    ...
                    >
                      ...
                      <div className="flex items-center justify-center gap-2 mb-4 mt-2">
                        ...
                        <input
                          type="number"
                          value={currentCopies}
                          onChange={(e) => handleInputChange(tier.id, e.target.value)}
