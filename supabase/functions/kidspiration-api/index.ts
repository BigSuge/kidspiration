...
app.get("/kidspiration-api/health", (c) => {
...
// Kid Signup
app.post("/kidspiration-api/auth/kid/signup", async (c) => {
    try {
...
// Kid Login
app.post("/kidspiration-api/auth/kid/login", async (c) => {
    try {
...
app.post("/kidspiration-api/auth/adult/signup", async (c) => {
    try {
...
app.post("/kidspiration-api/auth/adult/verify-otp", async (c) => {
    try {
...
// Adult Login
app.post("/kidspiration-api/auth/adult/login", async (c) => {
    try {
...
app.post("/kidspiration-api/auth/forgot-password", async (c) => {
    try {
...
app.post("/kidspiration-api/auth/reset-password", async (c) => {
    try {
...
// Track page visit
app.post("/kidspiration-api/analytics/page-visit", async (c) => {
    try {
...
app.get("/kidspiration-api/analytics/dashboard", async (c) => {
    try {
...
app.get("/kidspiration-api/admin/users", async (c) => {
    try {
